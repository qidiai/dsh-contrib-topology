...
export interface DashboardStatus {
    readonly topology: DashboardCard & {
        readonly summary?: TopologySummary;
    };
    readonly observe: DashboardCard & {
        readonly events?: readonly ObserveEventLite[];
    };
    readonly router: DashboardCard & {
        readonly providers?: readonly RouterProviderLite[];
    };
    readonly orchestrator: DashboardCard & {
        readonly history?: readonly OrchestratorHistoryLite[];
    };
    readonly mcpBridge: DashboardCard & {
        readonly servers?: readonly McpServerLite[];
    };
